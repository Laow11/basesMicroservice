...
router.post("/upload_DecoMoss", upload.single("file"), async (req, res) => {
  try {
    ...
    const jsonToXlsx = jsonData.map((datos) => {
      ...
      return {
        ...
        remito: datos.REMITO,
        "sender.empresa": null,
        "sender.remitente": "DECO MOS SA",
        "sender.calle": "AV OLIVOS",
        "sender.altura": "3764",
        "sender.localidad": "TORTUGUITAS",
    ...
    const xlsxFilePath = path.resolve("DECOMOSS.xlsx");
